...
PEEK_TRAIN = RemoteFileMetaData(
    url="https://raw.githubusercontent.com/sahanbull"
    "/PEEK-Dataset/main/datasets/v1/train.csv",
...
PEEK_TEST = RemoteFileMetaData(
    url="https://raw.githubusercontent.com/sahanbull"
    "/PEEK-Dataset/main/datasets/v1/test.csv",
...
PEEK_MAPPING = RemoteFileMetaData(
    url="https://raw.githubusercontent.com/sahanbull"
    "/PEEK-Dataset/main/datasets/v1/id_to_wiki_url_mapping.csv",
...
def load_peek_dataset(
    *,
    ...
    Args:
        ...
        variance:
            The default variance of the knowledge component of the learnable unit.
            Defaults to 1e-9.
        kc_init_func:
            The generator function of the knowledge component.
            Defaults to use KnowledgeComponent.
        train_limit:
    ...
    Returns:
        A tuple of (train, test) where train and test are both PEEKData.
        ...
        tuples (event, label) where event is an EventModel and label is a
        bool indicating whether the learner engages in this event.
