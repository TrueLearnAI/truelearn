...
def test_learner_model_default_construct():
...
def test_learner_meta_model_default_construct():
...
def test_event_model_default_construct():
...
def test_knowledge_component_construct_with_param():
...
def test_knowledge_component_update():
...
def test_knowledge_component_clone():
...
def test_knowledge_component_export_as_dict():
    kc = models.KnowledgeComponent(mean=1.0, variance=0.5)
...
def test_knowledge_component_repr(capsys):
    kc = models.KnowledgeComponent(mean=1.0, variance=0.5)
    print(kc)
...
def test_history_knowledge_component_construct_with_param():
...
def test_history_knowledge_component_update():
    kc = models.HistoryAwareKnowledgeComponent(
...
def test_history_knowledge_component_clone():
...
def test_history_knowledge_component_export_as_dict():
    kc = models.HistoryAwareKnowledgeComponent(
...
def test_history_knowledge_component_repr(capsys):
    kc = models.HistoryAwareKnowledgeComponent(mean=1.0, variance=0.5)
    print(kc)
...
def test_knowledge_topic_kc_pairs():
    knowledge = models.Knowledge()
...
def test_knowledge_update_kcs():
    knowledge = models.Knowledge({1: models.KnowledgeComponent(mean=0.0, variance=0.0)})

    kc = models.KnowledgeComponent(mean=1.0, variance=0.5)
    knowledge.update_kc(1, kc)
    assert knowledge.get_kc(1, models.KnowledgeComponent(mean=0.0, variance=0.5)) == kc


def test_knowledge_repr(capsys):
    knowledge = models.Knowledge({1: models.KnowledgeComponent(mean=0.0, variance=0.0)})
    print(knowledge)
